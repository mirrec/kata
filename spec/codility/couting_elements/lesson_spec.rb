require 'spec_helper'
require 'codility/counting_elements/lesson'

RSpec.describe Codility::CountingElements::Lesson do
  include Codility::CountingElements::Lesson
  ...
  it 'returns false if there is no swap that can make array sums equal' do
    ...
    expect(swap_of_elements(a, b)).to eq(false)
  end
end